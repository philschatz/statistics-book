...
<tr>
<td>3.33</td> <td>2.21</td> <td>2.45</td> <td>3.18</td>
</tr>
</tbody></table>
...
Use a solution sheet to conduct the following hypothesis tests. The solution sheet can be found in [the Table of Contents 14. Appendix](/m47129).
...
Examine the seven practice laps from [Terri Vogel's Log book](#m17132). Determine whether the mean lap time is statistically the same for the seven practice laps, or if there is at least one lap that has a different mean time from the others.
...
4.  Does the weight of the paper have an effect on how far the plane will travel? Use a 1% level of significance. Complete the test using the method shown in the bean plant example in [[link]](#element-349).
    ...
    * *MS<sub>between</sub>*= ___________
    * mean of the three sample variances ___________
    * *MS<sub>within</sub>* = _____________
