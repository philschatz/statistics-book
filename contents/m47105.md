...
{: data-type="newline"}
 ...
 <span data-type="list" data-list-type="enumerated" id="eip-idm31798608" data-number-style="lower-alpha"><span data-type="item">Linear equation: __________</span> <span data-type="item">*a* = ________</span> <span data-type="item">*b* = ________</span> <span data-type="item">*r* = ________</span> <span data-type="item">*n* = ________</span> </span>

</div>
</div>
<div data-type="exercise" id="element-578">
<div data-type="problem" id="id3231872" markdown="1">
Solve. <span data-type="list" data-list-type="enumerated" id="eip-idp112356080" data-number-style="lower-alpha"> <span data-type="item">When *x* = 1985, *ŷ* = _____</span> <span data-type="item">When *x* = 1990, *ŷ* =_____</span> <span data-type="item">When *x* = 1970, *ŷ* =______ Why doesn’t this answer make sense?</span> </span>
