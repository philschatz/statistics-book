...
We will round up to two and make each bar or class interval two units wide. Rounding up to two is one way to prevent a value from falling on a boundary. Rounding to the next number is often necessary even if it goes against the standard rules of rounding. For this example, using 1.76 as the width would also work. A guideline that is followed by some for the width of a bar or class interval is to take the square root of the data and then round to the nearest whole number, if necessary. For example, if there are 150 values of data, take the square root of 150 and round to 12 bars or intervals.
...
![Histogram consists of 8 bars with the y-axis in increments of 0.05 from 0-0.4 and the x-axis in intervals of 2 from 59.95-75.95.](../resources/fig-ch_02_04_01.jpg){: #eip-idm88475792 data-media-type="image/png"}
...
![Histogram consists of 6 bars with the y-axis in increments of 2 from 0-16 and the x-axis in intervals of 1 from 0.5-6.5.](../resources/fig-ch_02_04_02.jpg){: #eip-idp35221648 data-media-type="image/png"}


</div>

<div data-type="note" class="statistics calculator" data-label="" markdown="1">
Go to the [Appendix](/m47149). There are calculator instructions for entering data and for creating a customized histogram. Create the histogram for [\[link\]](#exampid2).
...
![A frequency polygon was constructed from the frequency table below.](../resources/CNX_Stats_C02_M05a_001.jpg){: #eip-idm19499056 data-media-type="image/jpg"}
...
![This is a horizontal boxplot over a number line that stretches from 0 to 350. The first whisker extends from 0 to the first quartile at 15. The box begins at the first quartile and extends to third quartile at 110. A vertical, dashed line is drawn at the median at 50, and the second whisker extends from the third quartile to the largest value at 330.](../resources/CNX_Stats_C02_M04_100.png){: #eip-idp57000416 data-media-type="image/png"}
...
<span data-type="media" data-display="block" data-alt="This is an overlay frequency polygon that matches the supplied data. The x-axis shows the grades, and the y-axis shows the frequency."> ![This is an overlay frequency polygon that matches the supplied data. The x-axis shows the grades, and the y-axis shows the frequency.](../resources/CNX_Stats_C02_M05a_002N.jpg){: data-media-type="image/jpg"} </span>
</div>
...
![This is a times series graph that matches the supplied data. The x-axis shows years from 2003 to 2012, and the y-axis shows the annual CPI.](../resources/CNX_Stats_C02_M05a_026annoN.jpg){: #eip-idm68714544 data-media-type="image/jpg"}
...
![This is a times series graph that matches the supplied data. The x-axis shows years from 2003 to 2012, and the y-axis shows the annual CPI.](../resources/CNX_Stats_C02_M05b_004.png){: #eip-idp40339472 data-media-type="image/png"}
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
To construct the histogram, determine appropriate minimum and maximum *x* and *y* values and the scaling. Sketch the histogram. Label the horizontal and vertical axes with words. Include numerical scaling.

![An empty graph template for use with this question.](../resources/fig-ch02_11_01.jpg){: #eip-idp57691072 data-media-type="image/jpg"}
...
![](../resources/CNX_Stats_C02_M03_101.jpg){: #eip-idp746160 data-media-type="image/png"}
...
![This is a frequency polygon that matches the supplied data. The x-axis shows the depth of hunger, and the y-axis shows the frequency.](../resources/CNX_Stats_C02_M05a_024annoN.jpg){: #eip-idp56723312 data-media-type="image/jpg"}
...
![](../resources/CNX_Stats_C02_M05a_028anno.jpg){: #eip-idp37153376 data-media-type="image/jpg"}
...
5.  In the following histogram, data values that fall on the right boundary are counted in the class interval, while values that fall on the left boundary are not counted (with the exception of the first interval where values on both boundaries are included). ![This is a histogram that matches the supplied data for couples. The x-axis shows total charges in intervals of 100 from 100 to 700, and the y-axis shows the relative frequency in increments of 0.05 from 0 to 0.30.](../resources/CNX_Stats_C02_M03_108.jpg){: #eip-idp2788752 data-media-type="image/jpg"}
