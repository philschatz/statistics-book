...
![This is a normal distribution curve with mean equal to zero. The values 0 and 0.1 are labeled on the horiztonal axis. A vertical line extends from 0.1 to the curve. The region under the curve to the right of the line is shaded to represent p-value = 0.0198.](../resources/CNX_Stats_C10_M03_item001anno.jpg){: data-media-type="image/jpg"}
