...
* Consider the [third exam/final exam example](/m17092#element-22).
...
The [95% Critical Values of the Sample Correlation Coefficient Table](/m17098) can be used to give you a good idea of whether the computed value of **<math xmlns="http://www.w3.org/1998/Math/MathML"><mi>r</mi></math>
...
![Horizontal number line with values of -0.624, -0.532, and 0.532.](../resources/fig-ch12_07_02.jpg "r = &#x2013;0.624-0.532. Therefore, r is significant."){: #id1165447908929 data-media-type="image/jpeg"}
...
Consider the [third exam/final exam example](/m17092#element-22). The line of best fit is: *ŷ* = –173.51+4.83*x* with *r* = 0.6631 and there are *n* = 11 data points. Can the regression line be used for prediction? **Given a third-exam score (*x* value), can we use the line to predict the final exam score (predicted *y* value)?**
