...
Suppose that one individual is randomly chosen. The probability that the person’s favorite pie is apple or the person is male is _____.
...
Suppose *H<sub>0</sub>* is: Favorite pie and gender are independent. The *p*-value is ______.
