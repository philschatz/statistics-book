...
**A test of independence determines whether two factors are independent or not.** You first encountered the term independence in [\[link\]](/m46938). As a review, consider the following example.
...
![Nonsymmetrical chi-square curve with values of 0 and 12.99 on the x-axis representing the test statistic of number of hours worked by volunteers of different types. A vertical upward line extends from 12.99 to the curve and the area to the right of this is equal to the p-value.](../resources/fig-ch11_05_01N.jpg){: data-media-type="image/jpg"}
...
![](../resources/CNX_Stats_C11_M05_tryit001annoN.jpg){: data-media-type="image/jpg"}
...
Refer back to the information in [Try It 1.6](#fs-idm24618832). How many service providing jobs are there expected to be in 2020? How many nonagriculture wage and salary jobs are there expected to be in 2020?
...
![Blank graph with vertical and horizontal axes.](../resources/fig-ch11_11_01.jpg){: data-media-type="image/jpg"}
