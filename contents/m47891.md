---
title: "Appendix F: Mathematical Phrases, Symbols, and Formulas"
layout: page
---
...
<table id="id7923354" summary="Symbols together with how they are pronounced are shown in a table."><caption><span data-type="title">Symbols and their Meanings</span></caption><thead>
 ...
 <mi>π</mi>
    ...
    <mo>¯</mo>
          ...
          <tr>
            <td>Descriptive Statistics</td>
            <td><span xmlns:x="http://www.w3.org/1999/xhtml" class="not-converted-yet">NOT\_CONVERTED\_YET: emphasis</span><emphasis xmlns="http://cnx.rice.edu/cnxml" data-effect="itelics">s</emphasis> <em>s<sub>x</sub></em> <em>sx</em></td>
            <td>s</td>
