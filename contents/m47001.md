...
A random survey of enrollment at 35 community colleges across the United States yielded the following figures: 6,414; 1,550; 2,109; 9,350; 21,828; 4,300; 5,944; 5,722; 2,825; 2,044; 5,481; 5,200; 5,853; 2,750; 10,012; 6,357; 27,000; 9,414; 7,681; 3,200; 17,500; 9,200; 7,380; 18,314; 6,557; 13,713; 17,768; 7,493; 2,771; 2,861; 1,263; 7,285; 28,165; 5,080; 11,622. Assume the underlying population is normal. <span data-type="list" data-list-type="enumerated" id="list10" data-number-style="lower-alpha"> <span data-type="item"> <span data-type="list" data-list-type="enumerated" id="list9" data-number-style="lower-roman"> <span data-type="item"><math xmlns="http://www.w3.org/1998/Math/MathML"> <mover accent="true"> <mi>x</mi> <mo>¯</mo> </mover> </math>
 = __________</span> <span data-type="item"><math xmlns="http://www.w3.org/1998/Math/MathML"> <mrow> <msub> <mi>s</mi> <mi>x</mi> </msub> </mrow> </math>
 = __________</span> <span data-type="item">*n* = __________</span> <span data-type="item">*n* – 1 = __________</span> </span> </span> <span data-type="item">Define the random variables <math xmlns="http://www.w3.org/1998/Math/MathML"> <mi>X</mi> </math>
